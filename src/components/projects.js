...
function Projects(){
    ...
    const [projects, setProject] = useState([
        ...
        },
        {
            ...
            text1: ["I used ", <a href="https://www.postman.com/" target="_blank" alt="postman link"><b>Postman</b></a>, " to manage API database"],
            final_header1: "",
            final_text1: "",
        },
        {
        ...
        },
        {
            ...
            text2: ["To incorporate and apply modernity to the renewed lululemon website, I looked over various web templates from pinterest and visited 1000+ websites from ", 
            ...
            text3: ["Using ", <a href="https://www.figma.com/" target="_blank" alt="Figma"><b>Figma</b></a>,
                ", ", 
            ...
            text4: ["My coding skill was limited because I only started learning HTML / CSS / JQuery a few months ago. So, I often needed to check page inspect to learn how certain styling works and compare with ",
